    ...
    render() {
        let destInfo = {
            ...
            '60-Beans':{
                ...
                letter:'W',
                challenge:"Welcome to 60 Beans. Try a free coffee. Find out the origin of the name. Instagram the business whatever way the mood strikes you. Get code form Joel."
            },
            'Mosaic-Craft-Cocktail-and-Beer-Lounge':{
                ...
                letter:'I',
                challenge:"Now that you've seen the inside it's time to see the outside. There is a prive party gong on, so for now just scope it out. Creatively Instagram whatever Mosaic's mood may be."
            },
            'Cafe-23':{
                title:'Cafe 23',
                description:"here is a new vetted cafe in town and they are great. Stop by for some tea and welcome them to the neighborhood. Great people, quality service, and we're digging their tone.",
                letter:'T',
                challenge:"Come get some free ice tea. Instagram this lovely cafe and let them know whatever the modd sent them their way."
            ...
            'The-Little-Soap-Shop':{
                ...
                letter:'I',
                challenge:"If they are open, stop by, hi-five the owner and have them direct you to is meaningful. FYI they are moving locations soon."
            },
            'The-Brass-Owl':{
                title:'The Brass Owl',
                description:"e are elated to welcome yet another incredible sponsor to the vetted Whateverthemood team. We love Astoria and we love The Brass Owl boutique. The staff is kind, the products are beautiful, and the overall vibe is one of ease and beauty.",
                letter:'W',
                challenge:"Welcome to The Brass Owl. I don't know, figure it out. Make it pretty ... but ask Nicole first."
            },
            'Zhicay-Shoe-Repair':{
            ...
            'Luludi':{
                ...
                letter:'W',
                challenge:"Just show up and refer to printed paper sheet for further instructions."
            },
            ...
            'Sparrow-Tavern':{
                ...
                letter:'T',
                challenge:"Welcome to Sparrow. Have a free adult Irish Coffee beverage. Find a light ficture that speaks to you and Instagram it, so we can feel it too."
            },
            'Versa-Fit':{
                title:'Versa Fit',
